...
export const Navigation = () => {
  ...
  return (
    <div onBlur={() => setOpen(false)} className={`flex flex-col justify-start bg-[#B52424] w-20 shadow-insetXD drop-shadow-2xl min-h-screen transition-width duration-500 ease-in-out ${open && 'w-40'}`}>
      <NavLink to="/CentralHUB" className="flex items-center justify-center">
      ...
      <nav className="flex items-center justify-center">
        <ul className="flex flex-col gap-5 text-white pt-5">
          <li>
            <NavLink to="/CentralHUB/workspace" className="group flex items-center justify-start">
          ...
          <li>
            <NavLink to="/CentralHUB/library" className="group flex items-center justify-start">
